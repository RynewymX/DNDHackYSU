document.addEventListener("DOMContentLoaded", function () {
    ...
    characters.forEach((character) => {
        ...
        link.href = `../playerScreen/map.html?name=${encodeURIComponent(character.character_name)}&level=${encodeURIComponent(character.character_level)}&spells=${encodeURIComponent(JSON.stringify(character.character_spells))}&stats=${encodeURIComponent(JSON.stringify(character.character_stats))}&icon=${encodeURIComponent(character.icon)}`;
